...
CREATE TABLE `plano_contas` (
  ...
  `codigo_planocontas` varchar(25) DEFAULT NULL,
  `descricao_planocontas` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id_planocontas`),
  KEY `fk_Plano_Contas_DRE1_idx` (`id_dre`),
  CONSTRAINT `fk_Plano_Contas_DRE1` FOREIGN KEY (`id_dre`) REFERENCES `dre` (`id_dre`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `plano_contas` VALUES (1,1,'123','Teste');
